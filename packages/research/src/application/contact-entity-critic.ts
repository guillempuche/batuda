...
export const contactCriticPrompt = (
	...
	return [
		...
		'  Praise reads as a customer testimonial only when the speaker is presented as',
		"  another company's voice; a founder or employee praising their own company is",
		'  still own_staff. Use "outsider" ONLY when you are confident the person is not',
		"  the target's own staff.",
