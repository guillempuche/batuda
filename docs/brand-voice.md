...
## Forbidden words — strike on sight

These words and phrases are banned in all customer-facing copy. The left column is what to strike; the right column is what to write instead.

### English

| Strike                 | Replace with                                   |
| ---------------------- | ---------------------------------------------- |
| Synergy / synergies    | (delete — there is no real equivalent needed)  |
| Leverage (as a verb)   | Use                                            |
| Solutions provider     | I build… (solo) / We build… (team)             |
| Trusted partner        | (delete)                                       |
| Digital transformation | (delete — or be specific: "replace the Excel") |
| Ecosystem              | The tools you already use                      |
| Unlock                 | (delete)                                       |
| Empower / empowering   | Give… back                                     |
| Seamlessly             | (delete)                                       |
| Cutting-edge           | (delete)                                       |
| Best-in-class          | (delete)                                       |
| Enterprise-grade       | (delete — the reader is not enterprise)        |
| Scalable               | (delete or rephrase concretely)                |
| Streamline             | Replace / remove / automate                    |
| Holistic               | (delete)                                       |
| Bespoke                | Custom / made for you                          |
| Elevate                | (delete)                                       |
| Revolutionise          | (delete)                                       |
...
| ------------------------ | -------------------------------- |
| Sinergias                | (borrar)                         |
| Transformación digital   | (borrar — ser concreto)          |
| Partner de confianza     | (borrar)                         |
| Soluciones a medida      | Herramientas hechas para ti      |
| Empoderar                | Devolver (el tiempo, el control) |
| Escalable                | (borrar o concretar)             |
| Ecosistema               | Las herramientas que ya usas     |
| Vanguardia               | (borrar)                         |
| Optimizar                | Reducir, automatizar, quitar     |
| Implementar una solución | Construir / poner en marcha      |
...
| --------------------- | ----------------------------- |
| Sinergies             | (esborrar)                    |
| Transformació digital | (esborrar — concret)          |
| Partner de confiança  | (esborrar)                    |
| Solucions a mida      | Eines fetes per a tu          |
| Escalable             | (esborrar o concretar)        |
| Ecosistema            | Les eines que ja fas servir   |
| Empoderar             | Tornar (el temps, el control) |
| Optimitzar            | Reduir, automatitzar, treure  |
...
- An explicit "how we build" or "our stack" page, clearly framed for tech-curious readers.
...
**Before:** *"Empowering SMBs to leverage AI for operational excellence."*
**After (en):** *"Machines do the work. You run the business."*
**After (ca):** *"Les màquines fan la feina. Tu fas el negoci."*
**After (es):** *"Las máquinas hacen el trabajo. Tú haces el negocio."*

### Service description

**Before:** *"Our bespoke integration solutions seamlessly connect your business ecosystem for enterprise-grade efficiency."*
**After (en):** *"I connect the tools you already use, so when X happens, Y happens. No copy-paste. Nothing forgotten."*
**After (ca):** *"Connecto les eines que ja fas servir perquè quan passi X, passi Y. Sense copiar i enganxar. Sense oblidar-se de res."*
**After (es):** *"Conecto las herramientas que ya usas para que cuando pase X, pase Y. Sin copiar y pegar. Sin olvidarse de nada."*

### CTA body

**Before:** *"Schedule a discovery consultation with our digital transformation experts."*
**After (en):** *"Tell me your case. I'll tell you honestly if I can build it. 20 minutes, free, no sales pitch."*
**After (ca):** *"Explica'm el teu cas. Et diré honestament si ho puc construir. 20 minuts, gratis, sense venda."*
**After (es):** *"Cuéntame tu caso. Te digo, honestamente, si puedo construirlo. 20 minutos, gratis, sin venta."*

### Proof line (when real proof exists)

**Before:** *"Trusted by industry-leading SMBs across Europe."*
**After (en):** *"A restaurant in Girona recovered 8 hours a week after I connected their POS to the accountant's software. That was the whole project."*

### Proof line (when real proof does not exist yet — the current state)

**Before:** *"Trusted by leading companies worldwide."*
**After (en):** *"I'm picking five SMBs this quarter to build real pilot cases with. Honest disclosure: I'm in the phase where I prove it, then publish prices."*

## Mission framing — always frame it this way

The mission has a fixed framing across all languages. Do not drift from it.
...
## Tone ladders — when to push each dial

| Dial        | ToFu (cold)     | MoFu (warm)            | BoFu (ready)                       |
| ----------- | --------------- | ---------------------- | ---------------------------------- |
| Empathy     | High            | Medium                 | Low                                |
| Proof       | Low (curiosity) | High (examples, cases) | High (risk reversal, social proof) |
...
### Catalan (`ca.ts`) — the source voice
...
- ❌ *"Expliqueu-me el vostre cas."* (vosaltres + *vostre*, distancing)

#### Vocabulary — use what a Catalan SMB owner actually says

| Use                                        | Avoid                                                            |
| ------------------------------------------ | ---------------------------------------------------------------- |
| pime / petita empresa                      | PYME (Castilianism in writing)                                   |
| autònom                                    | freelance (anglicism)                                            |
| comptable                                  | contable (Castilianism)                                          |
| gestoria / assessoria                      | consultoría (Castilianism + consultant tone)                     |
| TPV                                        | POS (anglicism)                                                  |
| pressupost                                 | presupuesto (Castilianism)                                       |
| full de càlcul                             | hoja de cálculo (Castilianism)                                   |
| correu                                     | email (acceptable but *correu* is warmer)                        |
| eines                                      | herramientas (Castilianism)                                      |
| feina                                      | treball (technically right, but *feina* is what the reader says) |
| taller                                     | workshop / estudio                                               |
| restauració / comerç de barri / assessoria | sector (abstract)                                                |
| poble / barri                              | localización                                                     |
| quan passi X, passi Y                      | cuando ocurra / when event happens                               |

#### Castilianism traps — the ones that sneak in most

Catalan copy written by Castilian-first writers almost always lands on the same set of errors. Strike them on sight.

| Castilianism                       | Catalan correct            |
| ---------------------------------- | -------------------------- |
| *donar-se conta*                   | *adonar-se*                |
| *tindre que*                       | *haver de*                 |
| *haiga*                            | *hagi*                     |
| *el mateix / la mateixa* (as "it") | restructure the sentence   |
| *aconteixement*                    | *esdeveniment* or *fet*    |
| *desde*                            | *des de*                   |
| *al menos*                         | *almenys*                  |
| *bueno* / *pues*                   | *bé* / *doncs*             |
| *enterar-se*                       | *assabentar-se* or *saber* |
| *acercar*                          | *apropar* or *acostar*     |
| *quedar-se amb*                    | *quedar-se*                |
| *plaç*                             | *termini*                  |
| *cualsevol*                        | *qualsevol*                |
| *después*                          | *després*                  |
| *entonces*                         | *llavors* or *aleshores*   |
| *vale* (OK)                        | *d'acord* or restructure   |
...
| Use                              | Avoid                                                 |
| -------------------------------- | ----------------------------------------------------- |
| pyme / pequeña empresa           | SMB (anglicism)                                       |
| autónomo                         | freelance                                             |
| gestoría                         | consultoría (unless the service really is consulting) |
| contable                         | accountant                                            |
| TPV                              | POS                                                   |
| hoja de cálculo                  | spreadsheet                                           |
| presupuesto                      | quote                                                 |
| herramientas que ya usas         | tu stack / tu ecosistema                              |
| restauración / comercio / taller | sector / industry                                     |
| cuando pase X, pase Y            | when event X occurs                                   |
| factura                          | invoice                                               |
| semana / mes                     | ciclo / periodo                                       |

#### Anglicism traps — the ones that sneak in most

Castilian marketing copy is flooded with anglicisms. Strike them.

| Anglicism    | Replace with                                      |
| ------------ | ------------------------------------------------- |
| *leads*      | *contactos* or *interesados*                      |
| *engagement* | (reescribir — casi nunca se necesita)             |
| *workflow*   | *flujo de trabajo* or *proceso*                   |
| *meeting*    | *reunión*                                         |
| *email*      | *correo* (acceptable, but *correo* is warmer)     |
| *deadline*   | *fecha límite* or *plazo*                         |
| *briefing*   | *sesión inicial* or *encargo*                     |
| *onboarding* | *puesta en marcha*                                |
| *feedback*   | *comentarios* or *respuesta*                      |
| *background* | *contexto* or *historial*                         |
| *target*     | *objetivo*                                        |
| *insights*   | *conclusiones* or *hallazgos*                     |
| *tips*       | *consejos*                                        |
| *know-how*   | *experiencia*                                     |
| *partner*    | (reescribir — ver tabla *Forbidden words* arriba) |
...
If any of these phrasings appear, the sentence is wrong. Rewrite as a shop owner would speak.
...
### English (`en.ts`) — outreach and future-international
...
#### Vocabulary — international SMB register

| Use                             | Avoid                               |
| ------------------------------- | ----------------------------------- |
| SMB / small business            | mid-market / enterprise             |
| business owner                  | stakeholder                         |
| accountant / bookkeeper         | finance function                    |
| POS                             | point-of-sale system (too formal)   |
| spreadsheet                     | Excel file (unless really Excel)    |
| invoice                         | billing document                    |
| workshop                        | studio / agency / consultancy       |
| restaurant / shop / consultancy | vertical / segment                  |
| tools you already use           | tech stack / ecosystem              |
| connection                      | integration (acceptable but colder) |
| small machine that…             | bot / agent / AI-powered feature    |

#### Anti-patterns — American B2B SaaS voice

The voice to avoid is the generic Silicon Valley B2B SaaS voice. It shows up in specific phrases. Strike them in addition to the cross-language *Forbidden words* table above.
...
| *10x*                          | give an actual number                   |
| *next-level*                   | (delete)                                |
| *no-brainer*                   | (delete)                                |
| *low-hanging fruit*            | (delete)                                |
| *circle back*                  | (delete)                                |
| *let's jump on a call*         | *let's talk* or *book a 20-minute call* |
| *reach out*                    | *get in touch* or *tell us*             |
| *deep dive*                    | *I'll look closely at…*                 |
| *actionable insights*          | (delete — say the specific action)      |
...
## Native-voice test — the 30-second calibration

Before returning any copy, read each language out loud (mentally is fine) and ask:

- **Catalan:** Would a comerciant in Girona say this over a cafè amb llet?
