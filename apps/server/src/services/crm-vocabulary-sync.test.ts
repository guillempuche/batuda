...
import { CRM_INDUSTRIES, CRM_REGIONS, CRM_SIZE_RANGES } from '@batuda/research'

describe('CRM vocabulary', () => {
	describe('when the research package mirrors the domain company vocabulary', () => {
		it('should hold identical industry, region, and size codes', () => {
			...
			expect([...CRM_REGIONS].sort()).toEqual([...COMPANY_REGIONS].sort())
