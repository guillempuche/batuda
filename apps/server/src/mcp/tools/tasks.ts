...
const CreateTask = Tool.make('create_task', {
	...
	parameters: Schema.Struct({
		...
		due_at: Schema.optionalKey(Schema.NullOr(Schema.String)),
		priority: Schema.optionalKey(TaskPriority),
		source: Schema.optionalKey(TaskSource),
		assignee_id: Schema.optionalKey(Schema.NullOr(Schema.String)).annotate({
			description:
		...
		linked_interaction_id: Schema.optionalKey(Schema.NullOr(Schema.String)),
		linked_calendar_event_id: Schema.optionalKey(Schema.NullOr(Schema.String)),
		linked_thread_link_id: Schema.optionalKey(Schema.NullOr(Schema.String)),
		linked_proposal_id: Schema.optionalKey(Schema.NullOr(Schema.String)),
...
const ListTasks = Tool.make('list_tasks', {
	...
	parameters: Schema.Struct({
		...
		statuses: Schema.optionalKey(Schema.Array(TaskStatus)),
		priority: Schema.optionalKey(TaskPriority),
		source: Schema.optionalKey(TaskSource),
		assignee_id: Schema.optionalKey(Schema.String).annotate({
			description:
				'Only the work waiting on one colleague, as a user id from list_members.',
		}),
		due_before: Schema.optionalKey(Schema.String),
		due_after: Schema.optionalKey(Schema.String),
		overdue_only: Schema.optionalKey(Schema.Boolean),
		include_snoozed: Schema.optionalKey(Schema.Boolean),
