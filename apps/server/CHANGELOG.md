...
## 2026-09-12 (server-v2026.9.12-1)
...
* **server:** replace the research model Nebius stopped serving ([6d48712](https://github.com/guillempuche/batuda/commit/6d48712849f5d11dc9b6af7efef57780f93d8950))
...
* hold a scan's list to the place its request named ([9d0fbbf](https://github.com/guillempuche/batuda/commit/9d0fbbfd818bcfb97e45982110525e1c42804dd9)), closes [#608](https://github.com/guillempuche/batuda/issues/608)

## 2026-09-03 (server-v2026.9.3)
...
* **server:** send a run's page count instead of every page ([df35b91](https://github.com/guillempuche/batuda/commit/df35b91799b76af39c763ec7ccf235ad3800a0fe))
...
* **server:** find a company whose name carries an accent ([00c8097](https://github.com/guillempuche/batuda/commit/00c8097f6cec18e5fa83d650fa528f4647a09b9d))
* **server:** refuse a database that cannot read letters outside a-z ([a77a841](https://github.com/guillempuche/batuda/commit/a77a841996af95ba9c5aabba307498186979d12a))
...
* **server:** keep two different things from sharing one name ([23ffc46](https://github.com/guillempuche/batuda/commit/23ffc46d054d9592c091ec4732421953eaf9ee26))
* **server:** let an email draft be started without naming a mailbox ([7dc9e0c](https://github.com/guillempuche/batuda/commit/7dc9e0c84d2997de204b5a6e35318af272d614d8)), closes [#510](https://github.com/guillempuche/batuda/issues/510)
* **server:** refuse a vouch that names no address ([4567d48](https://github.com/guillempuche/batuda/commit/4567d488b17fa01a926f8ab2943630d29b7ddc1d))
