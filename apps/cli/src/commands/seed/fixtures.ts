...
export const PRODUCTS = [
	{
		...
		defaultPrice: '990.00',
		priceType: 'fixed',
		targetIndustries: ['restaurants', 'retail', 'services'],
	},
	{
		...
		defaultPrice: '49.00',
		priceType: 'monthly',
		targetIndustries: ['restaurants', 'hospitality', 'services'],
	},
	{
		...
		priceType: 'fixed',
		targetIndustries: ['manufacturing', 'distribution', 'construction'],
	},
	{
		...
		priceType: 'fixed',
		targetIndustries: ['retail', 'manufacturing', 'distribution'],
	},
	{
		...
		defaultPrice: '300.00',
		priceType: 'monthly',
		targetIndustries: ['restaurants', 'retail', 'hospitality'],
	},
	{
		...
		defaultPrice: null,
		priceType: 'custom',
		targetIndustries: ['services', 'other'],
